...
import UserDatabase
import UserEntity
import com.example.challanges6.fragments.LoginFragment.Companion.LOGINUSER
import com.example.challanges6.fragments.LoginFragment.Companion.PASSWORD
import com.example.challanges6.fragments.LoginFragment.Companion.USERNAME
...
import com.example.challanges6.databinding.FragmentProfileBinding
...
class ProfileFragment : Fragment() {
    ...
    private fun openImagePicker() {
        val createIntent: Any = ImagePicker.with(this)
            .crop()
            .saveDir(
                File(
